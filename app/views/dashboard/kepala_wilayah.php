<div class="content-header">
    <h1><i class="fas fa-home me-2"></i>Dashboard Kepala Wilayah</h1>
...
<div class="row mb-4">
    <div class="col-md-4 mb-3">
        <div class="stats-card">
            ...
            <div class="stats-label">Pending Final Approval</div>
        </div>
    </div>
    <div class="col-md-4 mb-3">
        <div class="stats-card">
    ...
    <div class="col-md-4 mb-3">
        <div class="stats-card">
            <div class="icon bg-info"><i class="fas fa-file-alt"></i></div>
            <div class="stats-number"><?= $totalPengajuanTahunIni ?></div>
            <div class="stats-label">Total Pengajuan Tahun Ini</div>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>Pengajuan Menunggu Final Approval</h5>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center">Tidak ada pengajuan yang menunggu final approval</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
