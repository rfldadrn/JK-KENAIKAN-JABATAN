...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="<?= BASE_URL ?>/pekerja/store" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_golongan_saat_ini" name="id_golongan_saat_ini" required>
                            ...
                            <?php foreach ($golongan as $g): ?>
                                <option value="<?= $g->id_golongan ?>" <?= ($old['id_golongan_saat_ini'] ?? '') == $g->id_golongan ? 'selected' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_atasan" name="id_atasan">
                            ...
                            <?php foreach ($atasan as $a): ?>
                                <option value="<?= $a->id_pekerja ?>" <?= ($old['id_atasan'] ?? '') == $a->id_pekerja ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="nilai_kinerja_terakhir" 
                               ...
                               value="<?= $old['nilai_kinerja_terakhir'] ?? '' ?>">
                    </div>
                </div>
            </div>
